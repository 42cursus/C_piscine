...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/10 23:40:00 by abelov            #+#    #+#             */
/*   Updated: 2024/03/10 23:46:02 by abelov           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_iterative_factorial_test(int argc, char **argv);
int	ft_iterative_power_test(int argc, char **argv);
